...
class SendToDoListDeadlineNoticeMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if($this->isPlain){
            return $this->subject($this->data['mail_subject'])
                ->text('email_plain_template.to_do_list_deadline_notice',$this->data);
        } else {
            return $this->subject($this->data['mail_subject'])
                ->view('email_template.to_do_list_deadline_notice',$this->data);
        }
    }
}
