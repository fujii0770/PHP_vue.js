...
class SendDownloadReserveCompletedMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if($this->isPlain){
            return $this->subject($this->data['mail_subject'])
                ->text('email_plain_template.download_reserve_completed_template', $this->data);
		}else{
            return $this->subject($this->data['mail_subject'])
                ->view('email_template.download_reserve_completed_template', $this->data);
		}
    }
}
