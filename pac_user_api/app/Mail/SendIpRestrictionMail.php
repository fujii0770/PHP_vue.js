...
class SendIpRestrictionMail extends Mailable
{
    ...
    public function build()
    {
        ...
        if($this->isPlain){
            return $this->subject($this->data['mail_subject'])
                ->text('email_plain_template.SendIpRestrictionMail',$this->data);
        }
        else{
            return $this->subject($this->data['mail_subject'])
                ->view('email_template.SendIpRestrictionMail',$this->data);
        }
    }
}
