<div style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
    ...
    <div style="padding:16px 8px;background-color:white">
        ...
        <p>{{$creator_name}} さんから以下の回覧文書が届いています（再送）。</p>
        ...
        background-color: #107fcd;">
                        <a style="color:#fff;text-decoration: none;margin: 8px 20px;display: block" href="{{$circular_approval_url}}" target="_blank" class="m_-6849224559476667371link-button">回覧文書をみる</a></td>
                    <td style="width:20%"></td>
                </tr>
                </tbody>
            </table>
        ...
        <p>Shachihata Cloudを利用して、回覧文書を確認・捺印することができます。</p>
        <p>文書をクリックするとShachihata Cloudの画面に移動します。</p>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
            ...
            <tr>
                ...
                <td class="m_-6849224559476667371link-button" style="min-width: 140px; border: 1px solid whitesmoke; border-radius: 8px; text-align: center; vertical-align: middle; background-color: #107fcd;">
                    <a style="color:#fff;text-decoration: none;padding: 4px; display: block;margin: 8px 20px;" href="{{$env_app_url}}" class="m_-6849224559476667371link-button" target="_blank" data-saferedirecturl="">{{\App\Http\Utils\AppUtils::getMailLoginUrlLabel($env_app_url)}}</a></td>
                <td style="width:20%"></td>
            </tr>
            </tbody>
        </table>
        <p>&nbsp;</p>
        <section style="background-color: whitesmoke; padding: 1.0em; margin-left: 1em; margin-right: 1em;">
            <strong>この電子メールの内容をほかの人と共有しないでください</strong>
            <p>メールに記載された文書へのリンクを用いて、<wbr>Shachihata Cloudの文書にアクセスが可能です。
                 他の人に見られることがないように、メールの転送、<wbr>および文書へのリンクの転記は控えてください。
            </p>
          </section>
    </div>
