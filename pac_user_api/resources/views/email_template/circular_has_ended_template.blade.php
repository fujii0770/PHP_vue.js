<div style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif">
    <div style="width:100%;border-bottom:solid 1px gray;background-color:#FFA07A">
    ...
    background-color: #FFA07A;">
                        <a style="color:#fff;text-decoration: none;display: block;margin: 8px 20px" href="{{$circular_approval_url}}" class="m_-6849224559476667371link-button" target="_blank">回覧文書をみる</a>
                    </td>
                    <td style="width:20%"></td>
                </tr>
                </tbody>
