...
mix.js('resources/js/app.js', 'public/js')
    ...
    .sass('resources/sass/mfa.scss', 'public/css')
    ...
    .copy('resources/js/src/polyfill.min.js', 'public/js/polyfill.min.js')
    .copyDirectory('resources/assets/css/libs', 'public/css/libs')  // css lib
    .copyDirectory('resources/assets/js/libs', 'public/js/libs').version(); // js lib

console.log("*********** Chunks in "+ process.env.NODE_ENV);
