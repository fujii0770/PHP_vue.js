...
function getLS(key) {
    ...
    if (value && value !== 'null'){
        return Encryption.decode(localStorage.getItem(key));
    }else{
        return value;
    }
}
