...
return $settings = array(
    ...
    'sp' => array(
        ...
        'entityId' => env('PAC_APP_SAML_ENTITY_ID', 'ShachihataCloudApp-'.(config('app.app_server_env')?'K5':'AWS').'-'.config('app.pac_contract_server')),
    ...
    'idp' => array(
        ...
        'singleLogoutService' => array(
            ...
            'url' => 'https://accounts.google.com/logout',//$idp_host . '/sso/IDPSloRedirect/metaAlias/publicidp',
        ),
