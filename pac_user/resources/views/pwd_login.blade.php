...
<!-- Latest compiled and minified CSS -->
    ...
    <style type="text/css">
        ...
        .panel-login{
            ...
            /*overflow: auto;PAC_5-2572 スクロール消す*/
        }
        #loginbtn{
            margin-top:5%;
            margin-bottom:3%;
                ...
                $.ajax({
                    ...
                    success: function(data, textStatus, jqXHR){
                        ...
                        if(jqXHR.status === 203){
                            ...
                            $("#modalError .message").html(data.hasOwnProperty('message')?data.message:'メールアドレス、又はパスワードが正しくありません');
                            $("#modalError").modal();
...
<div class="page">
    <div class="content" style="overflow:auto;">
        ...
        <div class="content-right row-panel">
            <div>
                <!--<img class="logo" src="images/logo_shachihata.png" />-->
                <div id="login_r-text1" class="font1"><b></b></div><!--20210730　PAC_5-1775テキストファイルより出力1行目-->
                <div id="login_r-text2" class="font2"><b></b></div><!--20210730　PAC_5-1775テキストファイルより出力2行目-->
