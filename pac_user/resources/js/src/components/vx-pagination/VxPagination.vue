        ...
        computed: {
            ...
            showPageBtn() {
                let pageNum = Number(this.totalPage),
                    ...
                    arr = [];
                if ((!pageEspeciallyNum && pageNum <= 9) || (pageEspeciallyNum && pageEspeciallyNum <= 5)) {
            ...
            showCheckPageBtn () {
                let x = []
                for (let i = 0 ; i < this.showPageBtn.length ; i ++) {
                    const itemInPage = {
                        page: this.showPageBtn[i] !== "-" && this.showPageBtn[i] !== "+" ? this.showPageBtn[i] : "...",
                        key : this.showPageBtn[i],
                        class : this.showPageBtn[i] == this.currentPage ? 'is-current' : ''
                    };
                    x.push(itemInPage)
                }
                return x
