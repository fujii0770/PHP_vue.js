...
export default {
  ...
  data() {
    return {
      ...
      // disabledConfirmation: true,  // 決定ボタンチェック
  ...
  methods: {
    ...
    onEditorClick: function (e) {
      ...
      if (this.isPublic && (this.selectedId === 0 && !this.isTextSelected)) {
        this.stampIndex++;
        const callback = () => {
      ...
      if (!this.isPublic && !this.isTextSelected && !this.stampSelected) {
        return;
      }
      ...
      if(!this.isTextSelected) {
        ...
        if (e.target.attrs.type === 'Text') {
            ...
            this.color = Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + this.textIdSelected) ? this.changeColor['id_'+this.textIdSelected] : this.defaultFontColor
        ...
        let textNode = new Konva.Text({
            ...
            fontSize: Math.round(10*1.333333333*scale* this.realScale),
            fontFamily: 'shnmin',
            fontColor: Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + this.textIdSelected) ?this.changeColor['id_'+this.textIdSelected] : this.defaultFontColor ,
            fill: Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + this.textIdSelected) ?this.changeColor['id_'+this.textIdSelected] : this.defaultFontColor ,
            draggable: true,
            width: 50,
            type: 'Text'
        });
        if(!Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + this.textIdSelected)){
            this.changeColor['id_'+this.textIdSelected] = this.defaultFontColor
        }
        ...
        const text = {
            ...
            fontColor: Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + textNode.id()) ?this.changeColor['id_'+textNode.id()] : this.defaultFontColor ,
    ...
    doUpdateText: function(textNode) {
        textNode.attrs.fill = Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + textNode.id()) && this.changeColor['id_'+textNode.id()] != undefined ?this.changeColor['id_' + textNode.id()] : this.defaultFontColor
    ...
    drawingTem: function (textID) {
        ...
        const currentHeight  = fakeEl.height() +6
        fakeEl.remove();
        divSpace.style.width = (nodeText.attrs.width) +6+'px';
    ...
    loadTexts: function (draggable) {
        ...
        for(let text of this.page.texts) {
            ...
            let textNode = new Konva.Text({
                ...
                fontColor: this.changeColor['id_' + text.index],//this.changeColor.hasOwnProperty('id_'+this.textIndex)?this.changeColor['id_'+this.textIndex] : this.defaultFontColor,
                draggable: draggable,
    ...
    onTextDblClick: function(stage,textNode,textPosition,layer,isAdd,isChangeFlg) {
        ...
        textarea.style.width = `${((textNode.width() * scale  - textNode.padding() * 2)>=44) ? (textNode.width() * scale  - textNode.padding() * 2) : 44}px`;
        ...
        textarea.style.color = Object.prototype.hasOwnProperty.call(this.changeColor, "id_" + textNode.id()) ?this.changeColor['id_'+textNode.id()] : this.defaultFontColor;
