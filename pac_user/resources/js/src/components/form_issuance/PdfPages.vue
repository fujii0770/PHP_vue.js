    ...
    <div ref="container" class="content" style="position: relative; text-align: center;">
        <div style="display: inline-block;">
            <div ref="pages"
                ...
                <pdf-page-editor v-if="!!page.imageUrl" class="page"
                    ref="editors"
                    :data-index="index"
                ...
                <pdf-page-skeleton v-else class="page"
...
import PdfPageEditor from "../../components/form_issuance/PdfPageEditor";
import PdfPageSkeleton from "../../components/form_issuance/PdfPageSkeleton";
