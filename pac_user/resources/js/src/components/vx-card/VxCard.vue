 ...
 <template>
    <div class="vx-card" ref="card" :class="[
        ...
        <div ref="content" :class="['vx-card__collapsible-content',(!hideLoading ? 'vs-con-loading__container': ''),{collapsed: isContentCollapsed}, {'overflow-hidden': tempHidden}]" :style="StyleItems">
