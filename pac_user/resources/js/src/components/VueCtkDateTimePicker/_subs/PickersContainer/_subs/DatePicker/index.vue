...
<script>
  ...
  import { getWeekDays } from '@/components/VueCtkDateTimePicker/modules/month'
  ...
  import CustomButton from '@/components/VueCtkDateTimePicker/_subs/CustomButton'
  import KeyboardAccessibility from '@/components/VueCtkDateTimePicker/mixins/keyboard-accessibility'
...
<style lang="scss" scoped>
  ...
  @media screen and (max-width: 415px) {
    ...
    .datepicker-container:not(.inline) {
      .datepicker-controls {
