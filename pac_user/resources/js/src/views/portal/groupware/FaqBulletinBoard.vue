<template>
    <div id="faq_bulletin_board" :class="isMobile?'mobile':''">
     <vs-row>
<!--        <div class="mr-2 leftpanel">-->
<!--            <menu-left></menu-left>-->
<!--        </div>-->
        <div class="bbs">
            <top-menu v-if="!isMobile"></top-menu>
            <faq-bbs></faq-bbs>
        </div>
    </vs-row>
    </div>
...
import TopMenu from "../../../components/portal/TopMenu";
    import Bbs from "../../../components/portal/FaqBbs";
import FaqBbs from "../../../components/portal/FaqBbs";
    export default {
        ...
        mounted() {
 //           this.heightBbs = $(".iframe-groupware").outerHeight();
//            this.widthBbs = $(".iframe-groupware").outerWidth();
        }
    }
...
<style lang="scss">
  ...
  #faq_bulletin_board.mobile{
    ...
    .topic_menubar, .category_menubar{
