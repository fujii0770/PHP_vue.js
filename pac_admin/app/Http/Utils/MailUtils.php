...
class MailUtils
{
    ...
    const ADMIN_MFA_CODE_RELEASE = '011';//管理者:認証コードの発行
    const USER_MFA_CODE_RELEASE = '114';//利用者:認証コードの発行
    ...
    public static function InsertMailSendResume(
        ...
        $to_email = null // オプション利用者の受信メールアドレス
    ){
            ...
            switch($type){
                ...
                case AppUtils::MAIL_TYPE_USER :
                    ...
                    $target = DB::table('mst_user as MU')
                        ...
                        ->select('MU.mst_company_id as mst_company_id', 'MUI.enable_email as enable_email', 'MUI.email_format as email_format')->first();
                    break;
                default :
