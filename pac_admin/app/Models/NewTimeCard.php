...
class NewTimeCard extends Model
{
    ...
    public function punchDataInit($num)
    {
        ...
        switch ($num) {
            case 1;
                $punchData['start1'] = now()->toDateTimeString();
                break;
            case 2;
                $punchData['end1'] = now()->toDateTimeString();
                break;
            case 3;
                $punchData['start2'] = now()->toDateTimeString();
                break;
            case 4;
                $punchData['end2'] = now()->toDateTimeString();
                break;
            case 5;
                $punchData['start3'] = now()->toDateTimeString();
                break;
            case 6;
                $punchData['end3'] = now()->toDateTimeString();
                break;
            case 7;
                $punchData['start4'] = now()->toDateTimeString();
                break;
            case 8;
                $punchData['end4'] = now()->toDateTimeString();
                break;
            case 9;
                $punchData['start5'] = now()->toDateTimeString();
                break;
            case 10;
                $punchData['end5'] = now()->toDateTimeString();
                break;
        }
