        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">            
                ...
                <div class="modal-header">
                    <h4 class="modal-title" ng-if="!showResult&&!without_email_import_flg">CSV取込(グループウェア専用利用者登録)</h4>
                    <h4 class="modal-title" ng-if="!showResult&&without_email_import_flg">無ユーザーCSV取込(グループウェア専用利用者登録)</h4>
                ...
                <div class="modal-body form-horizontal">
                    ...
                    <div class="sapo">
                        <div ng-if="!showResult&&!without_email_import_flg">
                            ...
                            <br>
                            <div>CSV形式:</div>
                            <div>　ユーザID(xxx@domain.co.jp形式),通知先メールアドレス,姓,名,部署,役職,郵便番号,住所,電話番号,FAX番号,
                            ...
                            <div class="text-center">
                                ...
                                <label><button type="button" class="btn btn-primary" onclick="parent.location.href='/admin/import-history?type=3'"><span class="fas fa-file-import"></span>csv取込履歴一覧</button></label>
                            </div>
                        </div>
                        <div ng-if="!showResult&&without_email_import_flg">
                            <div>追加する利用者情報を記載したCSVファイルを指定してください。</div>
                            <br>
                            <div>CSV形式:</div>
                            <div>　ユーザID(xxx@domain.co.jp形式),通知先メールアドレス(空:固定),姓,名,部署,役職,郵便番号,住所,電話番号,FAX番号,
