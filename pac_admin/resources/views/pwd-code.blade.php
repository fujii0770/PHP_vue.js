            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR){
                    if(jqXHR.status === 203){
                        ...
                        window.location.href = '{{url("/errorView")}}/';
                    }else{
                        $("#modalError .message").html(data.message || 'エラーが発生しています。');
                        $("#modalError").modal();
                    }
                },
                        ...
                        {{csrf_field()}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <input id="code" type="code" name="code" style="width:100%" class="form-control" placeholder="ABCDEFG1234567" required>
...
@includeif('Code.modal')
@includeif('Code.errorModal')