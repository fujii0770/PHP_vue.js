            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" ng-if="!edit_flg">フォーマット詳細</h4>
                        <h4 class="modal-title" ng-if="edit_flg">フォーマット登録</h4>
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="card mt-3">
                            <div class="card-header" ng-if="!edit_flg">事前申請フォーマット詳細</div>
                            <div class="card-header" ng-if="edit_flg && !add_flg">事前申請フォーマット編集</div>
                            <div class="card-header" ng-if="add_flg">事前申請フォーマット登録</div>
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="form-group" ng-if="add_flg">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-26">
                                                <input type="text" required autocomplete="off" class="form-control" ng-model="item.form_code" id="form_code" ng-readonly="false" required maxlength="20"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="form_name"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">様式名<span style="color: red" ng-if="edit_flg">*</span></label>
                                        ...
                                        <div class="row" ng-if="edit_flg">
                                            ...
                                            <div class="col-md-9 col-sm-9 col-26">
                                                <input type="text" autocomplete="off" class="form-control" ng-model="item.form_name" id="form_name" ng-readonly="false" required maxlength="20"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="form_name"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">対象合計金額<span style="color: red" ng-if="edit_flg">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-26 disable" ng-if="!edit_flg">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="items_max"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">最大明細行数<span style="color: red" ng-if="edit_flg">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-26 disable" ng-if="!edit_flg">
                                                <p id="describe"><% item.items_max %></p>
                                            </div>
                                            <div class="col-md-9 col-sm-9 col-26 disable" ng-if="edit_flg">
                                            <input type="number" autocomplete="off" class="form-control" ng-model="item.items_max" id="items_max" ng-readonly="false"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="validity_period_from"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">有効期間<span style="color: red" ng-if="edit_flg">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-26 disable" ng-if="!edit_flg">
                                    ...
                                    <div class="form-group" ng-if="edit_flg">
                                        ...
                                        font-size:1em;border-radius:5px;">
                                            <div class="col-md-12 col-sm-12 col-12" style="display: inline-block;" ng-if="edit_flg && !add_flg">
                                                <span ng-repeat="pur_data in f_pur">
                                    ...
                                    <div class="form-group" ng-if="edit_flg">
                                        ...
                                        font-size:1em;border-radius:5px;">
                                            <div class="col-md-12 col-sm-12 col-12" style="display: inline-block;"  ng-if="edit_flg && !add_flg">
                                                <span ng-repeat="wtsm_data in f_wtsm">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="remarks"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">備考</label>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <label for="origin_file_name"
                                                   class="col-md-2 col-sm-2 col-10 text-right-lg">様式ファイル<span style="color: red" ng-if="edit_flg">*</span></label>
                                            <div class="col-md-9 col-sm-9 col-26 disable" ng-if="!add_flg">
                                                <p id="describe"><% item.origin_file_name %></p>
                                            </div>
                                        </div>
                                        <div class="row" ng-if="edit_flg && add_flg">
                                            <div class="col-md-2 col-sm-2 col-10 ">
                                            </div>
                                            <div class="col-md-9 col-sm-9 col-26">
                    ...
                    $http.get(link_ajax + "/" + $scope.item.form_code )
                        .then(function(event) {
                            ...
                            if(event.data.status == false){
                                ...
                                $scope.relation_flg=event.data.relation_flg;
