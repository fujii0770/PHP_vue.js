<div ng-controller="ListFrmIndexController">
    ...
    <form action="" name="adminForm">
        <div class="card mt-3">
            <div class="card-header">明細項目設定一覧</div>
            <div class="card-body">
                ...
                <table class="tablesaw-list tablesaw table-bordered adminlist mt-1" data-tablesaw-mode="swipe">
                    ...
                    <tr>
                        <th class="title sort" scope="col" data-tablesaw-priority="persist">
                            {!! \App\Http\Utils\CommonUtils::showSortColumn('項目名', 'index_name', $orderBy, $orderDir) !!}
                        </th>
                        <th class="title sort" scope="col" data-tablesaw-priority="persist">
...
@push('scripts')
    <script>
        if(appPacAdmin){
            appPacAdmin.controller('ListFrmIndexController', function($scope, $rootScope, $http){
                $rootScope.info = {};
                $rootScope.id = 0;
                    ...
                    $http.get(link_ajax + "/" + id)
                        .then(function(event) {
                            ...
                            if(event.data.status == false){
                                ...
                                $rootScope.info = event.data.item;
