<div ng-controller="DetailFrmIndexController">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title" ng-show="!info.id">明細項目情報登録</h4>
                        <h4 class="modal-title" ng-show="info.id">明細項目情報更新</h4>
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        {!! \App\Http\Utils\CommonUtils::showFormField('index_name','項目名','','text', false,
                                [ 'ng-model' =>'info.index_name', 'ng-readonly'=>"readonly", 'id'=>'index_name', 'maxlength' => 256]) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    {!! \App\Http\Utils\CommonUtils::buildSelect(\App\Http\Utils\AppUtils::FRM_INDEX_DATA_TYPE, 'data_type','','',
                    ...
                    <div class="modal-footer">
                        <ng-template ng-show="!info.id">
                            @canany([PermissionUtils::PERMISSION_FRM_INDEX_SETTING_CREATE])
                        ...
                        <ng-template ng-show="info.id">
                            @canany([PermissionUtils::PERMISSION_FRM_INDEX_SETTING_UPDATE])
                                <button type="submit" class="btn btn-success" ng-click="save()">
                        ...
                        <ng-template ng-show="info.id">
                            @canany([PermissionUtils::PERMISSION_FRM_INDEX_SETTING_DELETE])
...
@push('scripts')
    <script>
        if(appPacAdmin){
            appPacAdmin.controller('DetailFrmIndexController', function($scope, $rootScope, $http) {
                $scope.save = function(){
                    if($(".form_edit")[0].checkValidity()) {
                        ...
                        if(!$rootScope.info.id){
                            $http.post(link_ajax, {item: $rootScope.info})
                                .then(saveSuccess);
                        }else{
                            $http.put(link_ajax + "/" +$rootScope.info.id, {item: $rootScope.info})
                                .then(saveSuccess);
                        }
                    }
                };
