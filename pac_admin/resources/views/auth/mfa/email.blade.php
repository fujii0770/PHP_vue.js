...
<body>
@if ($terminate)
    <div class="modal fade" id="modal-message" tabindex="-1" data-backdrop="static" data-keyboard="false">
...
<div id="loginbox">
    <div class="side-login">
        <form method="post" action="extra-auth" class="loginform">
            ...
            <input type="submit" class="btn btn-success form-control" id="loginbtn" value="ログイン" />
        </form>
    </div>
    @if (session('message'))
