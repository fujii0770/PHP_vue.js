...
class CreateOperationHistory3Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history3', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history3` (
    ...
    {
        Schema::dropIfExists('operation_history3');
    }
}