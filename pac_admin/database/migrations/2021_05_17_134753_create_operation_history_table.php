...
class CreateOperationHistoryTable extends Migration {
	...
	public function up()
	{
        $ddl = "CREATE TABLE `operation_history` (
                    ...
                    `copy_flg` int(11) NOT NULL DEFAULT 0,
                  ...
                  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ユーザーの操作履歴を保持するテーブル'
