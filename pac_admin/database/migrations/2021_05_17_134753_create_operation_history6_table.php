...
class CreateOperationHistory6Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history6', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history6` (
    ...
    {
        Schema::dropIfExists('operation_history6');
    }
}