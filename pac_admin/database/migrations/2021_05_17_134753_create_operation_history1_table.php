...
class CreateOperationHistory1Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history1', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history1` (
    ...
    {
        Schema::dropIfExists('operation_history1');
    }
}