...
class CreateLongTermCircularUserTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('long_term_circular_user', function (Blueprint $table) {
            ...
            $table->tinyInteger("stamp_flg")->default(0)->nullable(false)->commit("捺印状況 0 承認(捺印なし)  1 承認(捺印あり)");
        ...
        DB::statement("ALTER TABLE long_term_circular_user MODIFY COLUMN title varbinary(256) NOT NULL comment '件名';");
    }
    ...
    {
        Schema::dropIfExists('long_term_circular_user');
    }
}
