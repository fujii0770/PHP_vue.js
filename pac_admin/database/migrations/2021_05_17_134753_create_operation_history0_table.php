...
class CreateOperationHistory0Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history0', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history0` (
    ...
    {
        Schema::dropIfExists('operation_history0');
    }
}