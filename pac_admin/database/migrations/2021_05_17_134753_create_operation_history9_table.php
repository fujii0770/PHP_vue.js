...
class CreateOperationHistory9Table extends Migration {
	...
	public function up()
	{
        Schema::table('operation_history9', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history9` (
	...
	{
		Schema::drop('operation_history9');
	}
