...
class CreateOperationHistory8Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history8', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history8` (
    ...
    {
        Schema::dropIfExists('operation_history8');
    }
}