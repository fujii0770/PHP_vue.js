...
class CreateEpsMFormPurposeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eps_m_form_purpose', function (Blueprint $table) {
            ...
            //PK
            $table->primary(['mst_company_id','form_code','purpose_name'],'primary_column');
            //FK
    ...
    {
        Schema::dropIfExists('eps_m_form_purpose');
    }
}
