...
class CreateExpensePlaceholderDataTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::dropIfExists('expense_placeholder_data');
        Schema::create('expense_placeholder_data', function (Blueprint $table) {
            $table->unsignedBigInteger('mst_company_id');
            $table->string('eps_m_form_code',20);
            $table->string('template_placeholder_name',20)->nullable();
            $table->string('cell_address',20)->nullable();
