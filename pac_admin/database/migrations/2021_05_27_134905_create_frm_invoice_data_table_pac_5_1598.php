...
class CreateFrmInvoiceDataTablePac51598 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('frm_invoice_data', function (Blueprint $table) {
            ...
            $table->string('invoice_no',1000)->nullable();
    ...
    {
        Schema::dropIfExists('frm_invoice_data');
    }
}
