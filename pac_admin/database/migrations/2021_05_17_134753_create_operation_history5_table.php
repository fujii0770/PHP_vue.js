...
class CreateOperationHistory5Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history5', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history5` (
    ...
    {
        Schema::dropIfExists('operation_history5');
    }
}