...
class CreateOperationHistory2Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history2', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history2` (
    ...
    {
        Schema::dropIfExists('operation_history2');
    }
}