...
class CreateMstCompanyStampGroupsRelationTable extends Migration {
	...
	public function up()
	{
		Schema::create('mst_company_stamp_groups_relation', function(Blueprint $table)
		{
			$table->integer('stamp_id')->primary()->comment('共通印ID');
	...
	{
		Schema::drop('mst_company_stamp_groups_relation');
	}
