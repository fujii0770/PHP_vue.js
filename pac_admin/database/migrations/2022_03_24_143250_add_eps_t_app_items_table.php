...
class AddEpsTAppItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('eps_t_app_items', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('t_app_id');
            $table->string('wtsm_name',20);
            $table->date('expected_pay_date');
            $table->decimal('unit_price',12)->nullable()->default(0);
            $table->unsignedInteger('quantity')->default(0);
            $table->decimal('expected_pay_amt',12)->nullable()->default(0);
            ...
            $table->unsignedTinyInteger('nonsubmit_type')->nullable();
            ...
            $table->foreign('t_app_id')->references('id')->on('eps_t_app');
