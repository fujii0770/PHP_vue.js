...
class CreateEpsMAccountTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('eps_m_account', function (Blueprint $table) {
            ...
            //PK
            $table->primary(['mst_company_id','account_name'],'primary_column');
            //FK
    ...
    {
        Schema::dropIfExists('eps_m_account');
    }
}
