...
class CreateOperationHistory4Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('operation_history4', function(Blueprint $table)
        {
            $ddl = "CREATE TABLE `operation_history4` (
    ...
    {
        Schema::dropIfExists('operation_history4');
    }
}